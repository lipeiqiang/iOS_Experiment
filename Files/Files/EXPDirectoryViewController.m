//
//  EXPDirectoryViewController.m
//  Files
//
//  Created by 5deg_MacBookAir on 13/03/13.
//  Copyright (c) 2013年 5deg_MacBookAir. All rights reserved.
//

#import "EXPDirectoryViewController.h"

@interface EXPDirectoryViewController ()

@end

@implementation EXPDirectoryViewController
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *closeButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"close"
                                                                       ...
                                                                       target:self
                                                                       action:@selector(closeDirectoryView)];
